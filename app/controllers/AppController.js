...
class AppController extends BaseController {
  ...
  async resolveTransactionWebhook(req, res) {
    const data = await this.appFactory.resolveTransactionWebhook(req);
  ...
  async getAuditLogs(req, res) {
    ...
    return AppController.pagination(data, req, res);
  }

  async uploadWebhookResponse(req, res) {
    const data = await this.appFactory.uploadWebhookResponse(req);

    return AppController.success(data, req, res);
  }

  async exportAuditLogs(req, res) {
    const data = await this.appFactory.exportAuditLogs(req.query);
